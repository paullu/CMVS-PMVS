...
int FindMatch::insideBimages(const Vec4f& coord) const {
...
int FindMatch::isNeighbor(const Patch::Cpatch& lhs, const Patch::Cpatch& rhs,
...
int FindMatch::isNeighborRadius(const Patch::Cpatch& lhs,
