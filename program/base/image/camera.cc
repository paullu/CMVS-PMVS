...
void Camera::getPAxes(const Vec4f& coord, const Vec4f& normal,
...
void Camera::setAxesScale(const float axesScale) {
  m_axesScale = axesScale;
}  

void Camera::intersect(const Vec4f& coord, const Vec4f& abcd,
